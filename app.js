...
const pokemon1 = pokemon[2]; 
const pokemon2 = pokemon[10]; 
const pokemon3 = pokemon[25]; 
...
let evolvedPokemon;
if (starter.number === 1) {
    evolvedPokemon = pokemon[1]; // Bulbasaur evolves into Ivysaur
} else if (starter.number === 4) {
    evolvedPokemon = pokemon[5]; // Charmander evolves into Charmeleon
} else if (starter.number === 7) {
    evolvedPokemon = pokemon[8]; // Squirtle evolves into Wartortle
} else if (starter.number === 25) {
    evolvedPokemon = pokemon[26]; // Pikachu evolves into Raichu
}

const starterIndex = game.party.indexOf(starter); 
if (starterIndex !== -1) {
...
const pokemonToCatch = pokemon[4]; 
...
const pokemonToCatchNew = pokemon[0]; 
game.catchPokemon(pokemonToCatchNew); 
